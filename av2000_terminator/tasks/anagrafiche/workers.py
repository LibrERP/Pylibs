...
from av2000_terminator.tasks.base import AbstractReadWorker, AbstractWriteWorker


class SuppliersDownloader(AbstractReadWorker):
...
class SuppliersUploader(AbstractWriteWorker):
...
class SuppliedCodeAllocator(Process):
    pass
# end SuppliedCodeAllocator
